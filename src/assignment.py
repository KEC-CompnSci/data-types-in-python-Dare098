...
word_4 = "were "
first = int(num_str_1)
second = int(num_str_2)
calculation = first + second
calculation_as_string = str(calculation)
actual_number = int(calculation)
sentence = word_1 + word_4 + word_2 + word_3
sentence = calculation_as_string + sentence